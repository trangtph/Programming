...
order_custom_region_long$ProductPricesInCP <- as.factor(order_custom_region_long$ProductPricesInCP)
...
nation_revenue <- order_custom_region %>% group_by(Nation) %>% summarise(revenue = sum(CartPriceInCP))
